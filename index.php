    ...
    <header class="fixed top-0 inset-x-0 z-50 bg-background-dark/80 backdrop-blur-md border-b border-border-dark transition-all duration-300">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            <a href="index.php" class="flex items-center gap-3 group">
                <div class="bg-primary text-background-dark p-1.5 rounded-lg group-hover:scale-105 transition-transform">
    ...
    <footer class="border-t border-border-dark bg-surface-dark py-12 mt-auto">
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="flex items-center gap-2">
                ...
                <span class="text-xl font-black text-slate-100 tracking-tight uppercase">Gold Cinema</span>
            </div>
            <p class="text-sm text-slate-500">© 2026 Gold Cinema. Tất cả các quyền được bảo lưu.</p>
        </div>
    </footer>
